...
## Should I apple?
- The decision of whether or not to apple comes down to a few decision points.
    - If your account has not done at least 2 lottos, you will likely get more value from saving apples for lotto events due to their better efficiency compared to this event.
    - Summer 6 rerun is also coming up and you may also consider appling for that event due to the efficiency (around 450 apd per run).
    - Something to keep in mind is that gem value is effectively 0 because lottos are a better source of those so each time you hit a gem you effectively "miss".
    - If you don't need multiple mats then the value of appling goes down.

## If I can't farm the 90+ node efficiently, where should I farm?
- If you want all tool types, farm St. Louis (65 assassin)
- If you want bronze mats/red shovels/blue hammers, farm Kansas City (70 caster)
- If you want silver mats/blue hammers/gold pickaxes, farm Omaha (80 berserker)
- If you want gold mats/red shovels/gold pickaxes, farm Peoria (90 archer)

# Recommended Support List and Free Quest Info (Final Map Released on May 2)
- Credits to [@niconikon01](https://twitter.com/niconikon01/status/1521057389910573056){:target="_blank"}

## Support List

![Support](https://pbs.twimg.com/media/FRvhV6BaMAANcDk?format=jpg&name=large)

## Free Quest Map

![FQ](https://pbs.twimg.com/media/FRvhSbjagAA9-SP?format=jpg&name=4096x4096)

# Challenge Quest
[Appmedia](https://appmedia.jp/fategrandorder/75475138){: .btn }{:target="_blank"}
[Wikia](https://fategrandorder.fandom.com/wiki/FGO_x_Learn_with_Manga!_Collaboration#Challenge_Quest){: .btn }{:target="_blank"}

- Main boss Daikokuten (2m/3m) will repeatedly summon mobs (up to 5 in the field) and reduce its hp by 100k (150k on break?) for every summon
- They will sometimes use an evade skill preventing you from dealing any damange.
